...
<?php if ($elements['Element_OphCoConsent_Other']->parent_guardian) {?>
	<p>
		Parent/tuteur: <?php echo $elements['Element_OphCoConsent_Other']->parent_guardian?>
	</p>
<?php }?>
<p>
...
<p>
	Je comprends que je recevrai une <?php echo $elements['Element_OphCoConsent_Procedure']->anaesthetic_type->name?> anesthésique.
</p>
<p>
		...
		<?php if ($elements['Element_OphCoConsent_Other']->witness_required) {?>
			...
			<tr>
				<td>
					<p>
						________________________<br/>
						<?php echo $elements['Element_OphCoConsent_Other']->witness_name?> (Témoin)
					</p>
				</td>
				<td>
					<p>
		...
		<?php if ($elements['Element_OphCoConsent_Other']->interpreter_required) {?>
			...
			<tr>
				<td>
					<p>
						________________________<br/>
						<?php echo $elements['Element_OphCoConsent_Other']->interpreter_name?> (Interprète)
					</p>
				</td>
				<td>
					<p>
