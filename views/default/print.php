...
<?php if ($elements['Element_OphCoConsent_Other']->parent_guardian) {?>
	<p>
		Parent/guardian: <?php echo $elements['Element_OphCoConsent_Other']->parent_guardian?>
	</p>
<?php }?>
<p>
...
<ul>
	<?php foreach ($elements['Element_OphCoConsent_Procedure']->procedures as $proc) {?>
		<li><?php echo $elements['Element_OphCoConsent_Procedure']->eye->adjective?> <?php echo $proc->term?></li>
	<?php }?>
</ul>
<p>
...
<ul>
	<?php foreach ($elements['Element_OphCoConsent_Procedure']->additional_procedures as $proc) {?>
		<li><?php echo $elements['Element_OphCoConsent_Procedure']->eye->adjective?> <?php echo $proc->term?></li>
	<?php }?>
</ul>
<p>
...
<ul>
	<?php foreach (explode(', ',trim($elements['Element_OphCoConsent_BenefitsAndRisks']->benefits)) as $benefit) {?>
...
<ul>
	<?php foreach (explode(', ',trim($elements['Element_OphCoConsent_BenefitsAndRisks']->risks)) as $risk) {?>
		<li><?php echo ucfirst($risk)?></li>
	<?php }?>
</ul>
<p>
	I understand that I will be given a <?php echo $elements['Element_OphCoConsent_Procedure']->anaesthetic_type->name?> anaesthetic.
</p>
<p>
...
<?php if ($elements['Element_OphCoConsent_Permissions']->tissues_id == 1) {?>
	<p>
		I hereby give consent for my tissues to be kept for education, auditing and research.
	</p>
<?php }?>
<?php if ($elements['Element_OphCoConsent_Other']->information) {?>
	<p>
...
<table>
	<thead>
		<tr><th></th><th></th></tr>
		<?php if ($elements['Element_OphCoConsent_Other']->witness_required) {?>
			<tr><th></th><th></th></tr>
			<tr><th></th><th></th></tr>
		<?php }?>
		<?php if ($elements['Element_OphCoConsent_Other']->interpreter_required) {?>
			<tr><th></th><th></th></tr>
			<tr><th></th><th></th></tr>
		<?php }?>
	</thead>
		...
		<?php if ($elements['Element_OphCoConsent_Other']->witness_required) {?>
			...
			<tr>
				<td>
					<p>
						________________________<br/>
						<?php echo $elements['Element_OphCoConsent_Other']->witness_name?> (Witness)
					</p>
				</td>
				<td>
					<p>
		...
		<?php if ($elements['Element_OphCoConsent_Other']->interpreter_required) {?>
			...
			<tr>
				<td>
					<p>
						________________________<br/>
						<?php echo $elements['Element_OphCoConsent_Other']->interpreter_name?> (Intepreter)
					</p>
				</td>
				<td>
					<p>
