...
/**
 * This is the model class for table "et_ophcoconsent_benfitrisk".
 *
...
class Element_OphCoConsent_BenefitsAndRisks extends BaseEventTypeElement
{
	public $service;
	...
	{
		return 'et_ophcoconsent_benfitrisk';
	}
